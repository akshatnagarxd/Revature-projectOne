package com.banking.controller.exception;
...
/**
 * Servlet implementation class ExceptionalServlet
 */
public class ExceptionalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExceptionalServlet() {
        super();
